...
namespace Guru.Markdown
{
    ...
    /// </summary>
    public class MarkdownUtils : MarkdownOptions
    {
        /// <summary>
        ...
        ///     
        /// </summary>
        //public MarkdownUtils(bool loadOptionsFromConfigFile)
        //{
        ...
        /// </summary>
        public MarkdownUtils(MarkdownOptions options)
        {
        ...
        private readonly Dictionary<string, string> _images = new Dictionary<string, string>(StringComparer.CurrentCultureIgnoreCase);
        ...
        public string GetArticle(int index, bool transformed = true)
        {
            ...
            var markdown = new MarkdownUtils(this);
